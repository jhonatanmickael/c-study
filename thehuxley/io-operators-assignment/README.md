...
This directory contains solutions for programming challenges hosted on [The Huxley](https://thehuxley.com/). Each subfolder represents a specific problem, following the curriculum of the **Programming 1 (2026.1)** course at UFAL.

---

## Challenge List

* **01-imc/**: Implementation of a Body Mass Index (BMI) calculator. It receives weight and height as input and returns the calculated index rounded to two decimal places.
